  ...
  const faqData = [
    {
      ...
      answer:
        "Our return policy allows you to return products within 30 days of purchase. Make sure the product is in its original condition.",
    },
    {
      question: "Do you offer international shipping?",
      answer:
        "Yes, we offer international shipping to select countries. Shipping fees and delivery times vary by location.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We offer a one-year warranty on all of our machinery. Extended warranties are available upon request.",
    },
  ];
